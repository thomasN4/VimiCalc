...
public class HelpMenu {
    ...
    private final String[] text = {
        ...
        "\t :macroDelay [ms] sets the delay between replayed macro keystrokes, so you can watch",
        "\t a macro play back step by step (no argument resets to 0 = instant; 'ESC' aborts a paced replay).",
        "\n",
        ...
        "\t With ':macroDelay 100', playback is paced at one keystroke per 100ms so you can watch it happen.",
        "\n",
